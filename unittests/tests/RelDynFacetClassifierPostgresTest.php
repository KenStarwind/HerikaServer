...
final class RelDynFacetPgDb
{
    ...
    public function insert($table, $data)
    {
        ...
        return $this->execQuery("INSERT INTO {$table} ({$cols}) VALUES ({$vals})");
    }
...
final class RelDynFacetClassifierPostgresTest extends TestCase
{
    ...
    public function testDwemerLoreWarmsAsheAndBoresAelaThroughThePostrequestHook(): void
    {
        ...
        $this->assertStringContainsString('<topic_resonance>Ashe was genuinely drawn in by the talk of dwemer', $ctxAshe);
        $this->assertStringContainsString('<topic_resonance>Aela the Huntress found the talk of dwemer tiresome', $ctxAela);
    ...
    {
        $this->build();
        $prefs = RelDynFacets::preferences(['facet_preferences' => self::AELA], 'Aela the Huntress');
        $t = RelDynFacetClassifier::topicTurn(['facet_preferences' => self::AELA], 'Aela the Huntress', ['dwemer', 'sabre_cat']);
        ...
        $this->assertStringContainsString('the talk of sabre cat', (string) $t['felt']);
    }
    ...
    public function testAGiftIsAppraisedByWhoReceivesIt(): void
    {
        ...
        $this->assertStringContainsString('Aela the Huntress turns the Ebony Mace over with real pleasure', $dAela['_last_gift_felt']);
        $this->assertStringContainsString('Ashe turns the Soul Gem over with real pleasure', $dAsheGem['_last_gift_felt']);
    }
}
