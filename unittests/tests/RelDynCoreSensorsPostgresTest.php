...
final class RelDynCoreSensorsPostgresTest extends TestCase
{
    ...
    public function testCombatBarkMeansInCombatFromCoreEventlog(): void
    {
        ...
        $this->assertSame('combat', RelationshipDynamics::detectInterestContext(RelationshipDynamics::LL_SERVICE));
    ...
    public function testCombatEndClosesTheFightButItStaysRecent(): void
    {
        ...
        // "In combat recently" (touch / service love languages read it): yes, 60 s ago.
        $this->assertSame('combat', RelationshipDynamics::detectInterestContext(RelationshipDynamics::LL_TOUCH));
        $this->assertNoMinaiRead();
    }
    ...
    public function testOldCombatAndMinaiFlagsAreNotCombat(): void
    {
        ...
        $this->assertNull(RelationshipDynamics::detectInterestContext(RelationshipDynamics::LL_TOUCH));
        $this->assertNoMinaiRead();
    }
    ...
    public function testCurrentInterestComesFromTheCorePlace(): void
    {
        ...
        $this->assertSame('adventure', RelationshipDynamics::detectCurrentInterest());
        $this->assertSame('adventure', RelationshipDynamics::detectInterestContext(RelationshipDynamics::LL_TIME));
        $this->assertNoMinaiRead();
    }

    public function testCurrentInterestIsUnknownWithoutCoreLocation(): void
    {
        // Only MinAI's _minai_lydia//locationkeywords / isinterior / issneaking exist.
        $GLOBALS['RELDYN_NPC_NAME'] = 'Lydia';
        $this->assertNull(RelationshipDynamics::detectCurrentInterest());
        $this->assertNoMinaiRead();
    }
