...
final class RelDynRomancePromotionPostgresTest extends TestCase
{
    ...
    /** A warrior: blade, bow and armor; a Circle member with a long trail of hunts. */
    private const WARRIOR = [
        'skills' => ['OneHanded' => 80, 'Archery' => 75, 'LightArmor' => 60, 'Block' => 40, 'Speech' => 25, 'Illusion' => 15],
        'kill_counts' => ['people' => 40, 'animals' => 60, 'creatures' => 20, 'dragons' => 1, 'undead' => 30],
        'faction_ranks' => ['Companions' => 2],
    ];

    /** A bard: silver tongue and illusion, barely a sword arm; a Companion who hunts. */
    private const BARD = [
        'skills' => ['Speech' => 95, 'Illusion' => 80, 'Sneak' => 55, 'OneHanded' => 10, 'Archery' => 10, 'LightArmor' => 12],
        'kill_counts' => ['people' => 5, 'animals' => 40, 'creatures' => 3, 'dragons' => 0, 'undead' => 2],
        'faction_ranks' => ['Companions' => 2],
    ];
    ...
    public function testAWarriorWinsAelaWithOneSignificantMoment(): void
    {
        ...
        $this->assertStringContainsString('[RelDyn-TYPE] Aela the Huntress -> Player: type platonic -> crush (promotion; romance: They sat by the fire', $this->log());
    ...
    public function testTheWarriorWhoFailsHerAttractionIsNotPromotedEither(): void
    {
        ...
        $this->playerStats(['skills' => ['Speech' => 50, 'OneHanded' => 15], 'kill_counts' => ['animals' => 2], 'faction_ranks' => []]);
    ...
    public function testRomanticNeedsTheSociologicalPillars(): void
    {
        ...
        $this->playerStats(['faction_ranks' => []] + self::WARRIOR);
