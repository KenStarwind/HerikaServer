 ...
 *   attraction       ['enabled' => bool, 'outcome' => ?string, 'modifier' => passion-gain multiplier,
 *                     'gate' => bool (the passion gate is open), 'score' => 0..1,
...
final class RelDynJev
{
    const UNITS = [
        ...
        'attraction.modifier' => 'passion-gain multiplier', 'attraction.score' => '0..1',
    ...
    public static function state(string $npcName, array $dynamics, float $now): array
    {
        ...
        $attraction = [
            ...
            'modifier' => round(floatval($a['passion_mult'] ?? $dynamics['_attraction_passion_mult'] ?? 1.0), 4),
