...
{"affinity_delta": X, "affinity_reason": "brief", "trust_delta": X, "trust_reason": "brief", "comfort_delta": X, "comfort_reason": "brief", "respect_delta": X, "respect_reason": "brief", "passion_delta": X, "passion_reason": "brief", "maturity_delta": X, "maturity_reason": "brief", "grievance": null}
...
passion_delta (-5 to +5): Did this interaction spark emotional/romantic intensity?
  Flirting, physical closeness, shared danger, playful teasing = positive.
  Rejection, coldness, boredom, routine business = negative.
  Not every interaction has romantic/intensity subtext. Most = 0.
...
{"significance": 1, "affinity_delta": 1, "affinity_reason": "brief insight", "trust_delta": 0, "trust_reason": "no trust signal", "comfort_delta": 0, "comfort_reason": "neutral exchange", "respect_delta": 0, "respect_reason": "no skill shown", "passion_delta": 0, "passion_reason": "no intensity", "maturity_delta": 0, "maturity_reason": "normal response", "grievance": null, "romantic_intent": 0}
...
PROMPT;
    ...
    private function parseEvalResponse($response) {
        ...
        if (isset($parsed['affinity_delta']) || isset($parsed['trust_delta']) || isset($parsed['comfort_delta'])) {
            ...
            $allZero = true;
            $deltaKeys = ['affinity_delta', 'trust_delta', 'comfort_delta', 'respect_delta', 'passion_delta', 'maturity_delta'];
